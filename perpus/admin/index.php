                            ...
                            <div class="panel-body" id="noti-box">
                                ...
                                ?>
                                    <div class="alert alert-success">
                                        ...
                                        <strong><?php echo $data3['fullname']; ?></strong>, Telah ditambahkan menjadi admin Perpustakaan BOOK-KU yang baru.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-info">
                                        ...
                                        <strong><?php echo $data4['judul']; ?></strong>, Buku bacaan baru yang ada di Perpustakaan BOOK-KU.
                                    </div>
                                <?php } ?>
                                ...
                                ?>
                                    <div class="alert alert-warning">
                                        ...
                                        <strong><?php echo $data5['nama']; ?> </strong> Pengunjung baru di Perpustakaan BOOK-KU.
                                    </div>
                                <?php } ?>
                            </div>
                        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7">
                        <section class="panel tasks-widget">
                            <header class="panel-heading">
                                Daftar Bacaan Perpustakaan BOOK-KU
                            </header>
