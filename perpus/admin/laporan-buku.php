...
/**
 ...
 Level  : Menengah
 Author : Perpustakaan BOOK-KU
 Blog   : www.PerpustakaanBOOK-KU.com
 Web    : www.PerpustakaanBOOK-KU.com
 Email  : perpustakaanbook-ku@gmail.com
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $pdf->Ln();
    $pdf->Cell(125);
    $pdf->Cell(30, 10, 'Website Perpustakaan BOOK-KU', 0, 0, 'C');
    $pdf->Ln();
}
