...
<head>
    <meta charset="UTF-8">
    <title>Perpustakaan BOOK-KU || Membaca menjadi lebih mudah!</title>
    ...
    <meta name="Perpustakaan BOOK-KU" content="Perpustakaan BOOK-KU" />
    <!-- bootstrap 3.0.2 -->
...
<body class="skin-black">
    ...
    <header class="header">
        <a href="index.php" class="logo" style="font-size:17.5px;">
            Perpustakaan BOOK-KU
        </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpustakaan BOOK-KU, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk Perpustakaan BOOK-KU" cols="25"></textarea>
                                                <!--<span class="help-block">A block of help text that breaks onto a new line and may extend beyond one line.</span>-->
                                            </div>
                                        </div>
                                        <div class="form-group">
    ...
    <div class="footer-main">
        Copyright Perpustakaan BOOK-KU 2022
    </div>
    </aside><!-- /.right-side -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpustakaan BOOK-KU</h4>
                </div>
                <div class="modal-body">
                    <p> Perpustakaan BOOK-KU adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpustakaan BOOK-KU memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari Perpustakaan BOOK-KU dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpustakaan BOOK-KU bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="sisteminformasi494@gmail.com">PerpustakaanBOOK-KU@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.PerpustakaanBOOK-KU.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
